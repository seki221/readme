...
ActiveRecord::Schema[7.0].define(version: 20_250_125_083_355) do
  ...
  create_table 'planners_schedules', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[planner_id schedule_id], name: 'index_planners_schedules_on_planner_id_and_schedule_id', unique: true
  end
